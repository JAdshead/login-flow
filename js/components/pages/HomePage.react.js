			...
			<article>
				<div>
					<section className="text-section">
						...
						<p>The default username is <code>AzureDiamond</code> and the default password is <code>hunter2</code>, but feel free to register new users! The registered users are saved to localStorage, so they will persist across page reloads.</p>
						{loggedIn ? (
